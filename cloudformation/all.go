...
import (
	"fmt"
	"github.com/fmechant/goformation/v4/cloudformation/accessanalyzer"
	"github.com/fmechant/goformation/v4/cloudformation/acmpca"
	"github.com/fmechant/goformation/v4/cloudformation/amazonmq"
	"github.com/fmechant/goformation/v4/cloudformation/amplify"
	"github.com/fmechant/goformation/v4/cloudformation/apigateway"
	"github.com/fmechant/goformation/v4/cloudformation/apigatewayv2"
	"github.com/fmechant/goformation/v4/cloudformation/appconfig"
	"github.com/fmechant/goformation/v4/cloudformation/applicationautoscaling"
	"github.com/fmechant/goformation/v4/cloudformation/appmesh"
	"github.com/fmechant/goformation/v4/cloudformation/appstream"
	"github.com/fmechant/goformation/v4/cloudformation/appsync"
	"github.com/fmechant/goformation/v4/cloudformation/ask"
	"github.com/fmechant/goformation/v4/cloudformation/athena"
	"github.com/fmechant/goformation/v4/cloudformation/autoscaling"
	"github.com/fmechant/goformation/v4/cloudformation/autoscalingplans"
	"github.com/fmechant/goformation/v4/cloudformation/backup"
	"github.com/fmechant/goformation/v4/cloudformation/batch"
	"github.com/fmechant/goformation/v4/cloudformation/budgets"
	"github.com/fmechant/goformation/v4/cloudformation/certificatemanager"
	"github.com/fmechant/goformation/v4/cloudformation/chatbot"
	"github.com/fmechant/goformation/v4/cloudformation/cloud9"
	"github.com/fmechant/goformation/v4/cloudformation/cloudformation"
	"github.com/fmechant/goformation/v4/cloudformation/cloudfront"
	"github.com/fmechant/goformation/v4/cloudformation/cloudtrail"
	"github.com/fmechant/goformation/v4/cloudformation/cloudwatch"
	"github.com/fmechant/goformation/v4/cloudformation/codebuild"
	"github.com/fmechant/goformation/v4/cloudformation/codecommit"
	"github.com/fmechant/goformation/v4/cloudformation/codedeploy"
	"github.com/fmechant/goformation/v4/cloudformation/codepipeline"
	"github.com/fmechant/goformation/v4/cloudformation/codestar"
	"github.com/fmechant/goformation/v4/cloudformation/codestarconnections"
	"github.com/fmechant/goformation/v4/cloudformation/codestarnotifications"
	"github.com/fmechant/goformation/v4/cloudformation/cognito"
	"github.com/fmechant/goformation/v4/cloudformation/config"
	"github.com/fmechant/goformation/v4/cloudformation/datapipeline"
	"github.com/fmechant/goformation/v4/cloudformation/dax"
	"github.com/fmechant/goformation/v4/cloudformation/directoryservice"
	"github.com/fmechant/goformation/v4/cloudformation/dlm"
	"github.com/fmechant/goformation/v4/cloudformation/dms"
	"github.com/fmechant/goformation/v4/cloudformation/docdb"
	"github.com/fmechant/goformation/v4/cloudformation/dynamodb"
	"github.com/fmechant/goformation/v4/cloudformation/ec2"
	"github.com/fmechant/goformation/v4/cloudformation/ecr"
	"github.com/fmechant/goformation/v4/cloudformation/ecs"
	"github.com/fmechant/goformation/v4/cloudformation/efs"
	"github.com/fmechant/goformation/v4/cloudformation/eks"
	"github.com/fmechant/goformation/v4/cloudformation/elasticache"
	"github.com/fmechant/goformation/v4/cloudformation/elasticbeanstalk"
	"github.com/fmechant/goformation/v4/cloudformation/elasticloadbalancing"
	"github.com/fmechant/goformation/v4/cloudformation/elasticloadbalancingv2"
	"github.com/fmechant/goformation/v4/cloudformation/elasticsearch"
	"github.com/fmechant/goformation/v4/cloudformation/emr"
	"github.com/fmechant/goformation/v4/cloudformation/events"
	"github.com/fmechant/goformation/v4/cloudformation/eventschemas"
	"github.com/fmechant/goformation/v4/cloudformation/fms"
	"github.com/fmechant/goformation/v4/cloudformation/fsx"
	"github.com/fmechant/goformation/v4/cloudformation/gamelift"
	"github.com/fmechant/goformation/v4/cloudformation/glue"
	"github.com/fmechant/goformation/v4/cloudformation/greengrass"
	"github.com/fmechant/goformation/v4/cloudformation/guardduty"
	"github.com/fmechant/goformation/v4/cloudformation/iam"
	"github.com/fmechant/goformation/v4/cloudformation/inspector"
	"github.com/fmechant/goformation/v4/cloudformation/iot"
	"github.com/fmechant/goformation/v4/cloudformation/iot1click"
	"github.com/fmechant/goformation/v4/cloudformation/iotanalytics"
	"github.com/fmechant/goformation/v4/cloudformation/iotevents"
	"github.com/fmechant/goformation/v4/cloudformation/iotthingsgraph"
	"github.com/fmechant/goformation/v4/cloudformation/kinesis"
	"github.com/fmechant/goformation/v4/cloudformation/kinesisanalytics"
	"github.com/fmechant/goformation/v4/cloudformation/kinesisanalyticsv2"
	"github.com/fmechant/goformation/v4/cloudformation/kinesisfirehose"
	"github.com/fmechant/goformation/v4/cloudformation/kms"
	"github.com/fmechant/goformation/v4/cloudformation/lakeformation"
	"github.com/fmechant/goformation/v4/cloudformation/lambda"
	"github.com/fmechant/goformation/v4/cloudformation/logs"
	"github.com/fmechant/goformation/v4/cloudformation/managedblockchain"
	"github.com/fmechant/goformation/v4/cloudformation/mediaconvert"
	"github.com/fmechant/goformation/v4/cloudformation/medialive"
	"github.com/fmechant/goformation/v4/cloudformation/mediastore"
	"github.com/fmechant/goformation/v4/cloudformation/msk"
	"github.com/fmechant/goformation/v4/cloudformation/neptune"
	"github.com/fmechant/goformation/v4/cloudformation/opsworks"
	"github.com/fmechant/goformation/v4/cloudformation/opsworkscm"
	"github.com/fmechant/goformation/v4/cloudformation/pinpoint"
	"github.com/fmechant/goformation/v4/cloudformation/pinpointemail"
	"github.com/fmechant/goformation/v4/cloudformation/qldb"
	"github.com/fmechant/goformation/v4/cloudformation/ram"
	"github.com/fmechant/goformation/v4/cloudformation/rds"
	"github.com/fmechant/goformation/v4/cloudformation/redshift"
	"github.com/fmechant/goformation/v4/cloudformation/robomaker"
	"github.com/fmechant/goformation/v4/cloudformation/route53"
	"github.com/fmechant/goformation/v4/cloudformation/route53resolver"
	"github.com/fmechant/goformation/v4/cloudformation/s3"
	"github.com/fmechant/goformation/v4/cloudformation/sagemaker"
	"github.com/fmechant/goformation/v4/cloudformation/sdb"
	"github.com/fmechant/goformation/v4/cloudformation/secretsmanager"
	"github.com/fmechant/goformation/v4/cloudformation/securityhub"
	"github.com/fmechant/goformation/v4/cloudformation/serverless"
	"github.com/fmechant/goformation/v4/cloudformation/servicecatalog"
	"github.com/fmechant/goformation/v4/cloudformation/servicediscovery"
	"github.com/fmechant/goformation/v4/cloudformation/ses"
	"github.com/fmechant/goformation/v4/cloudformation/sns"
	"github.com/fmechant/goformation/v4/cloudformation/sqs"
	"github.com/fmechant/goformation/v4/cloudformation/ssm"
	"github.com/fmechant/goformation/v4/cloudformation/stepfunctions"
	"github.com/fmechant/goformation/v4/cloudformation/transfer"
	"github.com/fmechant/goformation/v4/cloudformation/waf"
	"github.com/fmechant/goformation/v4/cloudformation/wafregional"
	"github.com/fmechant/goformation/v4/cloudformation/wafv2"
	"github.com/fmechant/goformation/v4/cloudformation/workspaces"
)
