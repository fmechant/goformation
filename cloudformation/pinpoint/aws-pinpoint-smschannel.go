...
// SMSChannel AWS CloudFormation Resource (AWS::Pinpoint::SMSChannel)
...
func (r *SMSChannel) AWSCloudFormationType() string {
	return "AWS::Pinpoint::SMSChannel"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SMSChannel) MarshalJSON() ([]byte, error) {
	type Properties SMSChannel
...
func (r *SMSChannel) UnmarshalJSON(b []byte) error {
	type Properties SMSChannel
	res := &struct {
		Type                string
		Properties          *Properties
